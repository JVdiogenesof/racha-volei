  ...
  return (
    <div className="mx-auto flex min-h-screen max-w-md flex-col items-center justify-center px-6 text-center">
      ...
      <p className="mt-2 text-gray-500">
        ...
        <strong className="text-brand-navy">{entry.phone}</strong>. Quando sobrar vaga de última
        hora em algum racha, um organizador vai te chamar por lá.
      </p>
      <Link href="/cadastro" className="mt-6 text-sm font-medium text-brand-purple hover:underline">
        Editar meus dados
      </Link>
    </div>
  );
