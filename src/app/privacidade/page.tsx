...
export default function PrivacidadePage() {
  return (
    <div className="mx-auto max-w-2xl px-6 py-12">
      ...
      <h1 className="text-2xl font-bold text-brand-navy">Política de Privacidade</h1>
      <p className="mt-1 text-sm text-gray-500">Última atualização: setembro de 2026</p>
      ...
      <div className="mt-8 space-y-6 text-sm leading-relaxed text-gray-700">
        ...
        <section>
          <h2 className="font-semibold text-brand-navy">Quais dados coletamos</h2>
        ...
        <section>
          <h2 className="font-semibold text-brand-navy">Como usamos esses dados</h2>
          <p className="mt-2">
        ...
        <section>
          <h2 className="font-semibold text-brand-navy">Quem pode ver seus dados</h2>
          <p className="mt-2">
        ...
        <section>
          <h2 className="font-semibold text-brand-navy">Exclusão de dados</h2>
          <p className="mt-2">
        ...
        <section>
          <h2 className="font-semibold text-brand-navy">Contato</h2>
          <p className="mt-2">
