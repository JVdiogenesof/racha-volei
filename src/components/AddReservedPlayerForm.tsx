...
export function AddReservedPlayerForm({
  action,
  players,
}: {
  ...
  return (
    <ActionForm
      action={action}
      successMessage="Jogador adicionado à lista de reservados!"
    ...
    >
      ...
      <span className="text-sm text-white/60">Adicionar alguém direto na lista</span>
      <select
        name="profileId"
        defaultValue=""
        required
