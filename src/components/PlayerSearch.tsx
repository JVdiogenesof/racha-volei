    ...
    <div>
      <div className="relative mt-6 max-w-sm">
        ...
        <input
          ...
          className="w-full rounded-lg border border-gray-300 py-2 pl-9 pr-3 text-sm focus:border-brand-purple focus:outline-none focus:ring-1 focus:ring-brand-purple"
        />
      </div>

      <div className="mt-4 grid gap-3 sm:grid-cols-2 lg:grid-cols-3">
        {filtered.map((p) => (
          <div key={p.id} className="flex items-center gap-4 rounded-xl border border-gray-200 p-4">
