...
export const PROFILE_COLUMNS =
  "id, full_name, birthdate, phone, avatar_url, nickname_badge, is_setter, attendance_frequency, has_vpa_shirt, wants_tournaments, is_organizer, status, guest_for_event_id";
